...
steps = 5000
# Create an increasing linear sequence from 0 to 1 over 4500 steps
up_steps = 4000
down_steps = 1000
up_prices = np.linspace(0, 1, up_steps)

# Create a decreasing linear sequence from 1 to 0 over 500 steps
down_prices = np.linspace(1, 1*(up_steps/(down_steps+up_steps)), down_steps)
