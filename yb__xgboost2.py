...
Original file is located at
    https://colab.research.google.com/drive/1LSlPq10Ic5vizW9SW__gE_24U7upNSJu
"""
...
gru_model = Sequential([
    GRU(128, return_sequences=True, input_shape=(window_size, len(features))),  # 1 GRU layer
    Dropout(0.3),  # 1 drop out
    GRU(128, return_sequences=True),  # 2 GRU
    Dropout(0.3),  #2 drop out
    GRU(128),  # 3 GRU
    Dropout(0.3),  # 3 drop out
